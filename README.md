...
v0.1.2 공개 뒤 첫 주간 작업은 매주 금요일 21:17(Asia/Seoul)에 실행되는 읽기 전용
배포 준비 점검이다. v0.1.3 로컬 후보에는 DBZ2 첫 수동 릴리스 리허설 PASS와
고정 증거 스냅샷을 연결했다. 현재 리허설은 1/3이며 별도 승인이 끝나기 전에는
